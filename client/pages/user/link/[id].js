...
const UpdateLinkPage = ({ oldLink, token }) => {
  ...
  return (
    ...
    <div className="row">
      ...
      <form onSubmit={submitHandler}>
        ...
        <div>
          <button type="submit" className="btn btn-outline-warning" disabled={!token}>{isAuth() || token ? 'Update' : 'Login to update'}</button>
        </div>
      </form>
      </div>
    </div>
...
UpdateLinkPage.getInitialProps = async ({ req, token, query }) => {
...
export default withUser(UpdateLinkPage);